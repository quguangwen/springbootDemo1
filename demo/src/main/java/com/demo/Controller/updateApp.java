...
//    }
    ...
    public ResponseVo<Object> updateAttachState(@RequestParam("mobile") String mobile, @RequestParam("status") String status, @RequestParam("type") String type){
       int a = updateLendAppStatus.updateAppAttachState(mobile, type, status);
    ...
    public ResponseVo<Object> deleteSaleDeviceToken(@RequestParam("saleID") String saleID){
        int a = deleteSale.delete(saleID);
    ...
    public ResponseVo<Object> updateAppState(@RequestParam("mobile") String mobile, @RequestParam("state_type") String state_type){
        ...
        int a = updateLendAppStatus.updateAppFinup(mobile,state_type.trim());
        if(a == 1){
    ...
    public ResponseVo<Object> getCustReslist(@RequestParam("saleno") String saleno, @RequestParam("mobile") String mobile, @RequestParam("product_name") String product_name){
        ...
        hashMapParam.put("sale_no",saleno);
        hashMapParam.put("mobile",AesUtils.encrypt(mobile));
        hashMapParam.put("product_name",product_name);
    ...
    public ResponseVo<Object> getAppFinupInfor(@RequestParam("mobile") String mobile){
        List list = appCustomerService.getAppFinupResult(mobile);
...
//    @RequestMapping(value="/getAttachmentItem", method = RequestMethod.GET)
//    @ResponseBody
//    public ResponseVo<Object> getAttachement(){
//        HashMap<Object,Object> hashMap = new HashMap<>();
//        hashMap = ReadProperties.getResourceMap("attachment.properties");
//        ResponseVo responseVo = new ResponseVo();
//        responseVo.setResult(hashMap);
//        return ResponseVo.ofSuccess(responseVo.getResult());
//    }
...
//    @RequestMapping(value = "/getProductList1", method = RequestMethod.GET)
//    @ResponseBody
//    public ResponseVo<Object> getProductName1(){
//        List<HashMap> list = new ArrayList<>();
//        list = appCustomerService.getProduct();
//        ResponseVo responseVo = new ResponseVo();
//        responseVo.setResult(list);
...
//    }
    ...
    public String getSelectResult(@RequestParam("mobile") String mobile, @RequestParam("path") String path){
        String applyNo = updateLendAppStatus.getMagicDataID(mobile);
    ...
    @ResponseBody
    public String getBCTest(@RequestParam("id_no") String id_no, @RequestParam("product_name") String product_code, @RequestParam("occupation_nature") String occupation_nature, @RequestParam("sale_no11") String sale_no){
        ResponseVo responseVo = new ResponseVo();

        String s =updateLendAppStatus.bcPush(id_no,product_code, occupation_nature,sale_no);
        return s;
//        int a = updateLendAppStatus.bcPush(id_no,product_code, occupation_nature);
//        if(a == 1){
//           return ResponseVo.ofSuccess();
//        } else {
//            return ResponseVo.ofError("it update failed");
//        }
    }
